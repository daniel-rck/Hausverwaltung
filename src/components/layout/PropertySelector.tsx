    ...
    <div className="flex items-center gap-2">
      ...
      {properties.length > 0 && (
        <select
          ...
          className="h-9 text-sm border border-stone-300 dark:border-stone-600 rounded-lg pl-3 pr-3 bg-white dark:bg-stone-700 text-stone-700 dark:text-stone-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-400 max-w-[180px]"
        >
          {properties.map((p) => (
