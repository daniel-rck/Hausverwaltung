          ...
          {moduleLinks.map((m) => {
            ...
            return (
              <Link
                key={m.path}
                to={m.path}
                className="group block bg-surface rounded-lg border border-border p-4 transition-colors hover:border-border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent/40 dark:focus-visible:ring-offset-zinc-950"
              >
                <span
                  aria-hidden="true"
